...
# 특정 컬럼값 일괄 변경 (다중 조건 연산)
df1['SpecialColumn'] = df1['SpecialColumn'].apply(lambda x: x * 4 if x > 20 else (x * 3 if x > 10 else (x * 2 if x > 5 else x)))
df2['SpecialColumn'] = df2['SpecialColumn'].apply(lambda x: x * 4 if x > 20 else (x * 3 if x > 10 else (x * 2 if x > 5 else x)))
df3['SpecialColumn'] = df3['SpecialColumn'].apply(lambda x: x * 4 if x > 20 else (x * 3 if x > 10 else (x * 2 if x > 5 else x)))
